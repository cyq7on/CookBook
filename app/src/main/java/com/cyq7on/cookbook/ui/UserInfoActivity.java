...
import com.cyq7on.cookbook.bean.AddFriendMessage;
...
public class UserInfoActivity extends ParentWithNaviActivity {
    ...
    @Bind(com.cyq7on.cookbook.R.id.iv_avator)
    ImageView iv_avator;
    @Bind(com.cyq7on.cookbook.R.id.tv_name)
    TextView tv_name;
...
//    Button btn_add_friend;
    @Bind(com.cyq7on.cookbook.R.id.btn_chat)
    Button btn_chat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.cyq7on.cookbook.R.layout.activity_user_info);
        initNaviView();
...
//            btn_add_friend.setVisibility(View.VISIBLE);
        ...
        ImageLoaderFactory.getLoader().loadAvator(iv_avator,user.getAvatar(), com.cyq7on.cookbook.R.mipmap.head);
...
//    }
    ...
    @OnClick(com.cyq7on.cookbook.R.id.btn_chat)
